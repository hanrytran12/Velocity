      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-xl shadow-neutral-100 border border-neutral-100 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-black text-[#1A2E35] tracking-tighter uppercase italic mb-2">Join Us</h1>
            <p className="text-sm text-neutral-400 font-bold uppercase tracking-widest">Create your premium account</p>
          </div>
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-[10px] font-black uppercase"><span className="px-3 bg-white text-neutral-300 tracking-widest leading-none translate-y-[-1px]">Or register with email</span></div>
          </div>

          {/* Register Form */}
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label className="block text-[11px] font-black text-neutral-400 uppercase tracking-widest mb-3 ml-1">Full Name</label>
              <input 
                type="text" 
                value={name}
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-[11px] font-black text-neutral-400 uppercase tracking-widest mb-3 ml-1">Password</label>
                <div className="relative group">
                  <input 
                    type={showPassword ? "text" : "password"} 
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                    className="w-full px-5 py-4 bg-neutral-50 border-2 border-transparent rounded-2xl outline-none focus:bg-white focus:border-orange-500/20 transition-all font-medium text-neutral-600 pr-12" 
                    placeholder="••••••••"
                    required
                    minLength={8}
                  />
                  <button 
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 text-neutral-400 hover:text-orange-500 transition-colors"
                  >
                    {showPassword ? (
              ...
              <div>
                <label className="block text-[11px] font-black text-neutral-400 uppercase tracking-widest mb-3 ml-1">Confirm</label>
                <div className="relative group">
                  <input 
            ...
            <div className="flex items-center gap-3 pt-2 ml-1">
              <input 
                type="checkbox" 
                id="terms" 
                className="w-5 h-5 rounded border-neutral-200 text-orange-500 focus:ring-orange-500 cursor-pointer" 
                required
              />
              <label htmlFor="terms" className="text-[10px] font-bold text-neutral-400 uppercase tracking-tight cursor-pointer">
                I agree to the <Link href="#" className="text-orange-500 underline">Terms</Link> & <Link href="#" className="text-orange-500 underline">Privacy</Link>
              </label>
            </div>
          ...
          {/* Footer */}
          <p className="mt-10 text-center text-xs font-bold text-neutral-400">
            ALREADY HAVE AN ACCOUNT? 
            <Link href="/login" className="ml-2 text-orange-500 hover:text-orange-600 transition-colors uppercase tracking-tight underline underline-offset-4">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
